#ifndef HDSA_ROL_FS_OBJECTIVE_MODEL_ERROR_HPP
#define HDSA_ROL_FS_OBJECTIVE_MODEL_ERROR_HPP

#include "ROL_Objective_SimOpt.hpp"

template <class RealT>
class ROL_FS_Objective_Model_Error: public HDSA::FS_Objective<RealT> {
...
public:
  ...
  ROL_FS_Objective_Model_Error(const HDSA::Ptr<ROL::Objective_SimOpt<RealT> > & obj): obj_(obj)
  { 
    tol_ = 1.e-8;
  }

  ~ROL_FS_Objective_Model_Error()
  { }
