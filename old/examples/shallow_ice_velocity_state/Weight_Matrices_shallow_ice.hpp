...
public:
  ...
  Weight_Matrices_shallow_ice(const HDSA::Ptr<HDSA::ParameterList> & parlist_sensitivity):
  ...
  {
    HDSA::Ptr<HDSA::Weight_Matrices<RealT> > weight_matrices = HDSA::makePtr<Weight_Matrices_shallow_ice<RealT> >(parlist_sensitivity_);
