#ifndef WEIGHT_MATRICES_STOKES_HPP
#define WEIGHT_MATRICES_STOKES_HPP

template <class RealT>
class Weight_Matrices_stokes : public HDSA::Weight_Matrices<RealT> {
...
public:
  ...
  Weight_Matrices_stokes(const HDSA::Ptr<HDSA::ParameterList> & parlist_sensitivity):
  ...
  {
    HDSA::Ptr<HDSA::Weight_Matrices<RealT> > weight_matrices = HDSA::makePtr<Weight_Matrices_stokes<RealT> >(parlist_sensitivity_);
