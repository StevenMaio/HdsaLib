...
public:
  PDE_CDR(Teuchos::ParameterList &parlist, Real & diff_coeff, Real & adv_coeff, Real & cubic_react_coeff, Real & linear_react_coeff) {
    ...
    adv_coeff_ = adv_coeff;
    cubic_react_coeff_ = cubic_react_coeff;
    linear_react_coeff_ = linear_react_coeff;
  }
