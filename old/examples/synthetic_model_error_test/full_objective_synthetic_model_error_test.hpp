#ifndef HDSA_SYNTHETIC_MODEL_ERROR_TEST_FS_OBJECTIVE_HPP
#define HDSA_SYNTHETIC_MODEL_ERROR_TEST_FS_OBJECTIVE_HPP

template <class RealT>
class synthetic_model_error_test_FS_Objective: public HDSA::FS_Objective<RealT> {
...
public:
  ...
  synthetic_model_error_test_FS_Objective(HDSA::Ptr<HDSA::Dense_Matrix<RealT> > & D, HDSA::Ptr<HDSA::Dense_Matrix<RealT> > & W, HDSA::Ptr<HDSA::Vector<RealT> > & data, RealT & beta): 
    D_(D), W_(W), data_(data), beta_(beta)
  { }

  ~synthetic_model_error_test_FS_Objective()
  { }
