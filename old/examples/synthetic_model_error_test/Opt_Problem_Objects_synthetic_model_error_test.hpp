#ifndef OPT_PROBLEM_OBJECTS_SYNTHETIC_MODEL_ERROR_TEST_HPP
#define OPT_PROBLEM_OBJECTS_SYNTHETIC_MODEL_ERROR_TEST_HPP

template <class RealT>
class Opt_Problem_Objects_synthetic_model_error_test : public HDSA::Opt_Problem_Objects<RealT> {
...
public:
  ...
  Opt_Problem_Objects_synthetic_model_error_test( )
  {

  }

  Opt_Problem_Objects_synthetic_model_error_test(const HDSA::Ptr<HDSA::Vector<RealT> > & theta_in, const HDSA::Ptr<const HDSA::Comm<int> > & comm)
  {
    // Load in data
    int dim = 51;
    ...
    HDSA::Opt_Problem_Objects<RealT>::rs_obj = HDSA::makePtr<synthetic_model_error_test_RS_Objective<RealT> >(D,W,data,beta);
    HDSA::Opt_Problem_Objects<RealT>::fs_obj = HDSA::makePtr<synthetic_model_error_test_FS_Objective<RealT> >(D,W,data,beta);
    HDSA::Opt_Problem_Objects<RealT>::con = HDSA::makePtr<synthetic_model_error_test_Constraint<RealT> >();
    HDSA::Opt_Problem_Objects<RealT>::u = HDSA::makePtr<Std_Vector<RealT> >(dim);
  }

  virtual ~Opt_Problem_Objects_synthetic_model_error_test()
  { }
  ...
  { 
    HDSA::Ptr<HDSA::Opt_Problem_Objects<RealT> > OP_Objects =  HDSA::makePtr<Opt_Problem_Objects_synthetic_model_error_test<RealT> >(theta,comm);
    return OP_Objects;
  }
