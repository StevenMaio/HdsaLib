#ifndef HDSA_SYNTHETIC_MODEL_ERROR_TEST_CONSTRAINT_HPP
#define HDSA_SYNTHETIC_MODEL_ERROR_TEST_CONSTRAINT_HPP

template <class RealT>
class synthetic_model_error_test_Constraint: public HDSA::Constraint<RealT> {

private:

public:

  synthetic_model_error_test_Constraint()
  { }
