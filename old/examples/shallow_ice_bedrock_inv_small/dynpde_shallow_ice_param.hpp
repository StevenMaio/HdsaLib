#ifndef PDEOPT_DYNAMIC_SHALLOW_ICE_PARAM_HPP
#define PDEOPT_DYNAMIC_SHALLOW_ICE_PARAM_HPP
...
template <class Real>
class DynamicPDE_shallow_ice_param : public DynamicPDE<Real> {
private:
  ...
  ROL::Ptr<PDE_shallow_ice_param<Real> > pde_;
  Real theta_;
...
public:
  DynamicPDE_shallow_ice_param(Teuchos::ParameterList &parlist) {
    pde_ = ROL::makePtr<PDE_shallow_ice_param<Real>>(parlist);
