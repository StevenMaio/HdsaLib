#ifndef WEIGHT_MATRICES_BAYES_HDSA_MODEL_ERROR_TEST_HPP
#define WEIGHT_MATRICES_BAYES_HDSA_MODEL_ERROR_TEST_HPP

template <class RealT>
class Weight_Matrices_bayes_hdsa_model_error_test : public HDSA::Weight_Matrices<RealT> {
...
public:
  ...
  Weight_Matrices_bayes_hdsa_model_error_test(const HDSA::Ptr<HDSA::ParameterList> & parlist_sensitivity):
  ...
  {
    HDSA::Ptr<HDSA::Weight_Matrices<RealT> > weight_matrices = HDSA::makePtr<Weight_Matrices_bayes_hdsa_model_error_test<RealT> >(parlist_sensitivity_);
