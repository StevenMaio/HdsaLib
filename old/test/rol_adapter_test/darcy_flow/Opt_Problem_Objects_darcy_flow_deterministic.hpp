#ifndef OPT_PROBLEM_OBJECTS_DARCY_FLOW_DETERMINISTIC_HPP
#define OPT_PROBLEM_OBJECTS_DARCY_FLOW_DETERMINISTIC_HPP

// ROL instantiation of Opt_Problem_Objects

template <class RealT>
class Opt_Problem_Objects_darcy_flow_deterministic : public Opt_Problem_Objects_ROL<RealT> {
...
public:
  ...
  Opt_Problem_Objects_darcy_flow_deterministic(const HDSA::Ptr<HDSA::ParameterList > & parlist_in, const HDSA::Ptr<const HDSA::Comm<int> > & comm): 
    Opt_Problem_Objects_ROL<RealT>(parlist_in,comm), parlist(parlist_in)
  { }

  Opt_Problem_Objects_darcy_flow_deterministic(const HDSA::Ptr<HDSA::ParameterList > & parlist_in, const HDSA::Ptr<HDSA::Vector<RealT> > & theta_in, const HDSA::Ptr<const HDSA::Comm<int> > & comm):
    Opt_Problem_Objects_ROL<RealT>(parlist_in,comm), parlist(parlist_in)
  {
    HDSA::nullstream bhs;
  ...
  virtual ~Opt_Problem_Objects_darcy_flow_deterministic()
  { }
  ...
  { 
    HDSA::Ptr<HDSA::Opt_Problem_Objects<RealT> > OP_Objects =  HDSA::makePtr<Opt_Problem_Objects_darcy_flow_deterministic<RealT> >(parlist,theta,comm);
    return OP_Objects;
  }
