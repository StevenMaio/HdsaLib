...
namespace HDSA
{
  ...
  public:
  MD_Multi_State_u_Hyperparameter_Interface(std::vector<HDSA::Ptr<HDSA::MD_u_Hyperparameter_Interface<RealT>>> & u_hyperparam_interface_std) :
   HDSA::MD_u_Hyperparameter_Interface<RealT>(u_hyperparam_interface_std[0]->Is_Transient()), u_hyperparam_interface_std_(u_hyperparam_interface_std)
   { 
