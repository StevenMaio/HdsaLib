...
for k = 1:100
    ...
    prior_delta{k}(:,1) = load(['prior_discrepancy_evaluated_at_z_',num2str(k),'/Vector_1.txt']);
    prior_delta{k}(:,2) = load(['prior_discrepancy_evaluated_at_z_',num2str(k),'/Vector_2.txt']);
    prior_delta{k}(:,3) = load(['prior_discrepancy_evaluated_at_z_',num2str(k),'/Vector_3.txt']);
end
