#ifndef HDSA_MD_Z_PRIOR_INTERFACE_MODEL_DISCREPANCY_SYNTHETIC_TEST_WITH_HESSIAN_GEVP_HPP
#define HDSA_MD_Z_PRIOR_INTERFACE_MODEL_DISCREPANCY_SYNTHETIC_TEST_WITH_HESSIAN_GEVP_HPP

template <class RealT>
class MD_z_Prior_Interface_model_discrepancy_synthetic_test_with_hessian_gevp : public HDSA::MD_z_Prior_Interface<RealT> {
...
public:
  MD_z_Prior_Interface_model_discrepancy_synthetic_test_with_hessian_gevp(const HDSA::Ptr<HDSA::Random_Number_Generator<RealT> > & random_number_generator): random_number_generator_(random_number_generator)
  { 
    m_ = 51;
