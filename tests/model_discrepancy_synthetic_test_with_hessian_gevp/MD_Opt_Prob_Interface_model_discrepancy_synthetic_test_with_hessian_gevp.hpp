#ifndef HDSA_MD_OPT_PROB_INTERFACE_MODEL_DISCREPANCY_SYNTHETIC_TEST_WITH_HESSIAN_GEVP_HPP
#define HDSA_MD_OPT_PROB_INTERFACE_MODEL_DISCREPANCY_SYNTHETIC_TEST_WITH_HESSIAN_GEVP_HPP

template <class RealT>
class MD_Opt_Prob_Interface_model_discrepancy_synthetic_test_with_hessian_gevp : public HDSA::MD_Opt_Prob_Interface<RealT> {
...
public:
  MD_Opt_Prob_Interface_model_discrepancy_synthetic_test_with_hessian_gevp()
  { 
    m_ = 51;
  ...
  virtual ~MD_Opt_Prob_Interface_model_discrepancy_synthetic_test_with_hessian_gevp()
  { }
