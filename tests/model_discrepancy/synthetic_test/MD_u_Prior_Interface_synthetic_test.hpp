#ifndef HDSA_MD_U_PRIOR_INTERFACE_SYNTHETIC_TEST_HPP
#define HDSA_MD_U_PRIOR_INTERFACE_SYNTHETIC_TEST_HPP

#include "HDSA_MD_u_Prior_Interface.hpp"

template <class RealT>
class MD_u_Prior_Interface_synthetic_test : public HDSA::MD_u_Prior_Interface<RealT>
{
...
public:
  MD_u_Prior_Interface_synthetic_test(const HDSA::Ptr<HDSA::Random_Number_Generator<RealT>> &random_number_generator) : random_number_generator_(random_number_generator)
  {
    m_ = 51;
  ...
  virtual ~MD_u_Prior_Interface_synthetic_test()
  {
  }
