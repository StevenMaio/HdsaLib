#ifndef HDSA_MD_Z_PRIOR_INTERFACE_SYNTHETIC_TEST_ELLIPTIC_PRIOR_HPP
#define HDSA_MD_Z_PRIOR_INTERFACE_SYNTHETIC_TEST_ELLIPTIC_PRIOR_HPP

#include "HDSA_MD_Elliptic_z_Prior_Interface.hpp"

template <class RealT>
class MD_Elliptic_z_Prior_Interface_synthetic_test_elliptic_prior : public HDSA::MD_Elliptic_z_Prior_Interface<RealT>
{
...
public:
  MD_Elliptic_z_Prior_Interface_synthetic_test_elliptic_prior(RealT &alpha_z, const HDSA::Ptr<HDSA::Random_Number_Generator<RealT>> &random_number_generator) : HDSA::MD_Elliptic_z_Prior_Interface<RealT>(alpha_z), random_number_generator_(random_number_generator)
  {
    m_ = 51;
  ...
  virtual ~MD_Elliptic_z_Prior_Interface_synthetic_test_elliptic_prior()
  {
  }
