...
def main():
    # Define paths
    executable_path = './diff_inv_test_example_sensitivity.exe'
    ...
    command = 'rm -f Forward_Euler_Cost_Report.txt grad_star_fe.txt grad_star_me.txt hessian_evals.txt Modified_Euler_Cost_Report.txt z_star_fe.txt z_star_me.txt'
