#ifndef OED_SPARSE_MATRIX_HPP
#define OED_SPARSE_MATRIX_HPP
...
namespace OED
{
    ...
    private:
        OED::Ptr<Tpetra::CrsMatrix<RealT, LO, GO, Node>> A_;
        bool is_symmetric_;
    ...
    public:
        ...
        Sparse_Matrix(OED::Ptr<Tpetra::CrsMatrix<RealT, LO, GO, Node>> &A, bool is_symmetric = false) : A_(A), is_symmetric_(is_symmetric)
        {
        }
        ...
        Sparse_Matrix(OED::Vector<RealT> &vec, bool reciprocate_diag)
        {
            ...
            A_ = OED::makePtr<Tpetra::CrsMatrix<RealT, LO, GO, Node>>(map, 1);
        ...
        OED::Ptr<const Teuchos::Comm<int>> Get_Comm(void) const
        {
            return A_->getComm();
        }
        ...
        OED::Ptr<Tpetra::CrsMatrix<RealT, LO, GO, Node>> Get_Tpetra_Matrix(void) const
        {
            return A_;
        }
