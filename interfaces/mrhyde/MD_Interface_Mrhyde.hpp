...
public:
  ...
  {  
    ...
    //              PDE solver (solve object?)
    //              reduced space objective
    //              adjoint object
    //              vector interface, need HDSA_vector
    m_ = 51;
  ...
  {
    // logic to choose which data target, perturbations of input to high fidelity (ex. WRF-SFIRE) 
