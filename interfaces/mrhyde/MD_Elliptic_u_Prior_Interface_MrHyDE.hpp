...
class MD_Elliptic_u_Prior_Interface_MrHyDE : public HDSA::MD_Elliptic_u_Prior_Interface<RealT> {
  ...
  public:
  MD_Elliptic_u_Prior_Interface_MrHyDE(RealT & alpha_u, RealT & beta_u, HDSA::Ptr<HDSA_Prior_FE_Op_MrHyDE_Interface<RealT>> &prior_fe_op, HDSA::Ptr<HDSA::Vector<RealT> > &uvec):
      HDSA::MD_Elliptic_u_Prior_Interface<RealT>(alpha_u), prior_fe_op_(prior_fe_op)
    {
      Construct_Elliptic_Operator(beta_u,uvec);
    }

  MD_Elliptic_u_Prior_Interface_MrHyDE(RealT & alpha_u, RealT & beta_u, HDSA::Ptr<HDSA_Prior_FE_Op_MrHyDE_Interface<RealT>> &prior_fe_op, HDSA::Ptr<HDSA::Vector<RealT> > &uvec, int & seed):
  ...
  void Construct_Elliptic_Operator(RealT &beta_u, HDSA::Ptr<HDSA::Vector<RealT> > &uvec) {
