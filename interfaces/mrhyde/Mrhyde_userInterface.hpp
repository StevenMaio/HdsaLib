...
#ifndef HDSA_MRHYDE_USERINTERFACE_H
#define HDSA_MRHYDE_USERINTERFACE_H
...
namespace HDSA {
 ...
 /** \class  MrHyDE::UserInterface
   \brief  Manages input file and instantiates various preliminary objects 
   */
  
  //template< class Node>
  class Mrhyde_UserInterface {
  ...
  public:
    ...
    //   Mrhyde_UserInterface() {};
    
    Mrhyde_UserInterface(std::string input_file_name) {
      input_file_name_ = input_file_name;
      settings_ = Mrhyde_settings(input_file_name_);    
    };

    ~Mrhyde_UserInterface() {};

    std::string input_file_name_;
    RCP<Teuchos::ParameterList> settings_;
    ...
    //    Teuchos::RCP<Teuchos::ParameterList> Mrhyde_UserInterface(const std::string & filename) {
    Teuchos::RCP<Teuchos::ParameterList> Mrhyde_settings(const std::string & filename) {
      ...
      //settings_ = rcp(new Teuchos::ParameterList("MrHyDE"));
