#ifndef MODEL_ERROR_OBJECTS_SYNTHETIC_MODEL_ERROR_TEST_HPP
#define MODEL_ERROR_OBJECTS_SYNTHETIC_MODEL_ERROR_TEST_HPP

// Instantiation of Model_Error_Objects

template <class RealT>
class Model_Error_Objects_synthetic_model_error_test : public HDSA::Model_Error_Objects<RealT> {
...
public:
  ...
  Model_Error_Objects_synthetic_model_error_test(const HDSA::Ptr<HDSA::ParameterList> & parlist_sensitivity, const HDSA::Ptr<HDSA::Opt_Problem_Objects<RealT> > & OP_Objects_Factory, 
  ...
  virtual ~Model_Error_Objects_synthetic_model_error_test()
  { }
  ...
  {
    // Gamma
    std::vector<RealT> gamma = std::vector<RealT>(dim,0.0);
    // read in data
