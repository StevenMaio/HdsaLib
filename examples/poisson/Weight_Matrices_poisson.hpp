#ifndef WEIGHT_MATRICES_POISSON_HPP
#define WEIGHT_MATRICES_POISSON_HPP

template <class RealT>
class Weight_Matrices_poisson : public HDSA::Weight_Matrices<RealT> {
...
public:
  ...
  Weight_Matrices_poisson(const HDSA::Ptr<HDSA::ParameterList> & parlist, const HDSA::Ptr<HDSA::ParameterList> & parlist_sensitivity):
  ...
  {
    HDSA::Ptr<HDSA::Weight_Matrices<RealT> > weight_matrices = HDSA::makePtr<Weight_Matrices_poisson<RealT> >(parlist_,parlist_sensitivity_);
