...
#include "Weight_Matrices_shallow_ice.hpp"
#include "Parameter_Sampler_shallow_ice.hpp"
...
int main(int argc, char *argv[]) {
  ...
  HDSA::Ptr<HDSA::Opt_Problem_Objects<RealT> > OP_Objects_Factory = HDSA::makePtr<Opt_Problem_Objects_shallow_ice<RealT> >(parlist, comm);
  HDSA::Ptr<HDSA::Weight_Matrices<RealT> > weight_matrices_factory = HDSA::makePtr<Weight_Matrices_shallow_ice<RealT> >(parlist,parlist_sensitivity);
  HDSA::Ptr<HDSA::Parameter_Sampler<RealT> > sampler = HDSA::makePtr<Parameter_Sampler_shallow_ice<RealT> >(parlist);
