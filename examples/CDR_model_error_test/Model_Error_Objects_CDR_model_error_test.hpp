#ifndef MODEL_ERROR_OBJECTS_CDR_MODEL_ERROR_TEST_HPP
#define MODEL_ERROR_OBJECTS_CDR_MODEL_ERROR_TEST_HPP

// Instantiation of Model_Error_Objects

template <class RealT>
class Model_Error_Objects_CDR_model_error_test : public HDSA::Model_Error_Objects<RealT> {
...
public:
  ...
  Model_Error_Objects_CDR_model_error_test(const HDSA::Ptr<HDSA::ParameterList> & parlist_sensitivity, const HDSA::Ptr<HDSA::Opt_Problem_Objects<RealT> > & OP_Objects_Factory, 
  ...
  virtual ~Model_Error_Objects_CDR_model_error_test()
  { }
  ...
  void Construct_Objects(const HDSA::Ptr<const HDSA::Comm<int> > & comm)
  {
    ...
    // L
    L = HDSA::makePtr<HDSA::Dense_Matrix<RealT> >(u_dim,u_dim);
    // read in data
    ...
    // Linv
    Linv = HDSA::makePtr<HDSA::Dense_Matrix<RealT> >(u_dim,u_dim);
    // read in data
