#ifndef WEIGHT_MATRICES_DARCY_FLOW_LIS_HPP
#define WEIGHT_MATRICES_DARCY_FLOW_LIS_HPP

template <class RealT>
class Weight_Matrices_darcy_flow_LIS : public HDSA::Weight_Matrices<RealT> {
...
public:
  ...
  Weight_Matrices_darcy_flow_LIS(const HDSA::Ptr<HDSA::ParameterList> & parlist_sensitivity):
  ...
  {
    HDSA::Ptr<HDSA::Weight_Matrices<RealT> > weight_matrices = HDSA::makePtr<Weight_Matrices_darcy_flow_LIS<RealT> >(parlist_sensitivity_);
