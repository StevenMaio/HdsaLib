...
#include "Weight_Matrices_darcy_flow_LIS.hpp"
#include "Parameter_Sampler_darcy_flow_LIS.hpp"
...
int main(int argc, char *argv[]) {
  ...
  HDSA::Ptr<HDSA::Opt_Problem_Objects<RealT> > OP_Objects_Factory = HDSA::makePtr<Opt_Problem_Objects_darcy_flow_LIS<RealT> >(parlist, comm);
  HDSA::Ptr<HDSA::Weight_Matrices<RealT> > weight_matrices_factory = HDSA::makePtr<Weight_Matrices_darcy_flow_LIS<RealT> >(parlist_sensitivity);
  HDSA::Ptr<HDSA::Parameter_Sampler<RealT> > sampler = HDSA::makePtr<Parameter_Sampler_darcy_flow_LIS<RealT> >(parlist);
