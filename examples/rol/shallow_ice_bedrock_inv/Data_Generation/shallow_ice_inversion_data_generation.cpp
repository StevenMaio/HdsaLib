...
int main(int argc, char *argv[])
{
  ...
  HDSA::Ptr<const Teuchos::Comm<int>> comm = Tpetra::getDefaultComm();
  ...
  // Initialize PDE
  HDSA::Ptr<DynamicPDE_shallow_ice<RealT>> pde = HDSA::makePtr<DynamicPDE_shallow_ice<RealT>>(*parlist);

  /*************************************************************************/
  /***************** BUILD CONSTRAINT **************************************/
  /*************************************************************************/
  HDSA::Ptr<DynConstraint<RealT>> dyn_con = HDSA::makePtr<DynConstraint<RealT>>(pde, meshMgr, comm, *parlist, *outStream);
  ...
  if (checkDeriv)
  {
    uo->randomize(2900.0, 3200.0);
    un->randomize(2900.0, 3200.0);
    z->randomize(-18.0, -15.0);
