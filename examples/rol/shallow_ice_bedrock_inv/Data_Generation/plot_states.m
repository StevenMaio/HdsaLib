...
for i = times
  ...
  view(2);
  axis square;
  title(['Surface Height (m) at t=',num2str(Tmesh(i))]);
  xlabel('x (km)');
  ylabel('y (km)');
  colorbar
  %set(gca, 'FontSize', 16);
  set(gcf, 'Color', 'White');% tightfig;
  fname = ['/ascldap/users/wmreese/Documents/Paper_Plots/Surface_Height_',num2str(i)];
  ...
  fname = ['/ascldap/users/wmreese/Documents/Presentation_Plots/31x31_mesh_T_2_nt_25/vx_',num2str(i)];
  ...
  colorbar
  set(gca, 'FontSize', 16); set(gcf, 'Color', 'White');% tightfig;
  fname = ['/ascldap/users/wmreese/Documents/Presentation_Plots/31x31_mesh_T_2_nt_25/vy_',num2str(i)];
