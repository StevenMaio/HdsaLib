...
public:
  RS_Objective(const std::vector<RealT> &weights, const std::vector<ROL::Ptr<ROL::Objective<RealT>>> &obj) : ROL::LinearCombinationObjective<RealT>(weights, obj), obj_(obj)
  {
  }
