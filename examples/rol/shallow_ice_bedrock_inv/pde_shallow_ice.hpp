...
public:
                ...
                const ROL::Ptr<const std::vector<Real>> &z_param = ROL::nullPtr)
  {
    ...
    ROL::Ptr<Intrepid::FieldContainer<Real>> valBeta_eval = ROL::makePtr<Intrepid::FieldContainer<Real>>(c, p);
    ...
    ROL::Ptr<Intrepid::FieldContainer<Real>> gradS_eval = ROL::makePtr<Intrepid::FieldContainer<Real>>(c, p, d);
    fe_->evaluateGradient(gradS_eval, U[0]);

    // COMPUTE BASAL VELOCITY
    ROL::Ptr<Intrepid::FieldContainer<Real>> kappa = ROL::makePtr<Intrepid::FieldContainer<Real>>(c, p);
    ...
    Real A = A_;
    ROL::Ptr<Intrepid::FieldContainer<Real>> h = ROL::makePtr<Intrepid::FieldContainer<Real>>(c, p);
                  ...
                  const ROL::Ptr<const std::vector<Real>> &z_param = ROL::nullPtr)
  {
    ...
    ROL::Ptr<Intrepid::FieldContainer<Real>> kappa = ROL::makePtr<Intrepid::FieldContainer<Real>>(c, p);
    computeBasalVelocity(kappa, valBeta_eval, valS_eval, valB_eval, 0);
    ROL::Ptr<Intrepid::FieldContainer<Real>> d_kappa = ROL::makePtr<Intrepid::FieldContainer<Real>>(c, p);
    ...
    ROL::Ptr<Intrepid::FieldContainer<Real>> h = ROL::makePtr<Intrepid::FieldContainer<Real>>(c, p);
    computeThermalVelocity(h, valS_eval, valB_eval, A, 0);
    ROL::Ptr<Intrepid::FieldContainer<Real>> d_h = ROL::makePtr<Intrepid::FieldContainer<Real>>(c, p);
                  ...
                  const ROL::Ptr<const std::vector<Real>> &z_param = ROL::nullPtr)
  {
    ...
    // COMPUTE BASAL VELOCITY
    ROL::Ptr<Intrepid::FieldContainer<Real>> d1_kappa = ROL::makePtr<Intrepid::FieldContainer<Real>>(c, p);
    computeBasalVelocity(d1_kappa, valBeta_eval, valS_eval, valB_eval, 1);
    ROL::Ptr<Intrepid::FieldContainer<Real>> d2_kappa = ROL::makePtr<Intrepid::FieldContainer<Real>>(c, p);
    ...
    ROL::Ptr<Intrepid::FieldContainer<Real>> h = ROL::makePtr<Intrepid::FieldContainer<Real>>(c, p);
    computeThermalVelocity(h, valS_eval, valB_eval, A, 0);
    ROL::Ptr<Intrepid::FieldContainer<Real>> d1_h = ROL::makePtr<Intrepid::FieldContainer<Real>>(c, p);
    computeThermalVelocity(d1_h, valS_eval, valB_eval, A, 1);
    ROL::Ptr<Intrepid::FieldContainer<Real>> d2_h = ROL::makePtr<Intrepid::FieldContainer<Real>>(c, p);
    ...
    ROL::Ptr<Intrepid::FieldContainer<Real>> d1_v = ROL::makePtr<Intrepid::FieldContainer<Real>>(c, p);
    computeSurfaceVelocity(d1_v, valS_eval, valB_eval, A, 1);
    ROL::Ptr<Intrepid::FieldContainer<Real>> d2_v = ROL::makePtr<Intrepid::FieldContainer<Real>>(c, p);
