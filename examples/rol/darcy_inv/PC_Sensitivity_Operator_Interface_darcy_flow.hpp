...
public:
  PC_Sensitivity_Operator_Interface_darcy_flow(HDSA::Ptr<ROL::Objective<RealT> > & robj, HDSA::Ptr<HDSA::Vector<RealT> > & z_vec, HDSA::Ptr<HDSA::Vector<RealT> > theta_vec): robj_(robj)
  {
