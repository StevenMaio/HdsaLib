...
for i = times
  ...
  fname = ['/ascldap/users/wmreese/Documents/State_Snapshots_GIS/51x51_mesh_T_10_nt_41/s_',num2str(i)];
  ...
  colorbar
  set(gca, 'FontSize', 16); set(gcf, 'Color', 'White');% tightfig;
  fname = ['/ascldap/users/wmreese/Documents/State_Snapshots_GIS/51x51_mesh_T_10_nt_41/vx_',num2str(i)];
  ...
  colorbar
  set(gca, 'FontSize', 16); set(gcf, 'Color', 'White');% tightfig;
  fname = ['/ascldap/users/wmreese/Documents/State_Snapshots_GIS/51x51_mesh_T_10_nt_41/vy_',num2str(i)];
